...
(function () {
  ...
  function replaceChildren(...nodes) {
    ...
    if (nodes.length) this.append.apply(this, nodes);
  }
...
function cleanup() {
  entries(cache).forEach(function ([id, {
    isRoot: isRoot,
    isSplit: isSplit
  }]) {
    if (!isRoot || !isSplit) {
...
_gsap.gsap.registerPlugin(_gsap.ScrollTrigger);
...
var splitLines = document.querySelectorAll('[tr-split-element]');
var instancesOfSplit = [];
// Split the text up
function runSplit() {
  splitLines.each(function (index) {
    var currentElement = $(this);
    instancesOfSplit[index] = new _splitType.default(currentElement, {
      types: "lines, words"
    });
  });
...
runSplit();
var heroTypeSplit = new _splitType.default(".intro-title", {
  types: "words, chars",
  tagName: "span"
});
...
window.addEventListener("DOMContentLoaded", function (event) {
  ...
  function attr(defaultVal, attrVal) {
    var defaultValType = _typeof(defaultVal);
  ...
  $("[tr-pagecolor-element='trigger']").each(function (index) {
    ...
    // settings
    var classSetting = attr("mode-2", triggerEl.attr("tr-pagecolor-class"));
    // result
    _gsap.ScrollTrigger.create({
      trigger: triggerEl,
      start: "top center",
      end: "bottom center",
  ...
  var yrSpan = document.querySelector(".current_year");
  // get the current year
  var currentYr = new Date().getFullYear();
  // set the year span element's text to the current year
  yrSpan.textContent = currentYr;
});
var callout_triggger = ".callout_trigger";
var visual = ".iphone-inner-visual-item";
var section = ".sticky-callout-section";
...
$(callout_triggger).each(function (index) {
  ...
  var mySection = $(this).closest(section);
  var targetElement = mySection.find(visual).eq(myIndex);
  var tl = _gsap.gsap.timeline({
    scrollTrigger: {
      trigger: $(this),
      // trigger element - viewport
...
var homePageSections = $(".sticky_section-list-wrapper").children();
var stickySection = $(".sticky_home-section");
...
var horizontalItem = $(".horizontal-item");
var horizontalSection = $(".horizontal-section");
var moveDistance;
function calculateScroll() {
  ...
  var moveAmount = horizontalItem.length - itemsInView;
  var minHeight = scrollSpeed * horizontalItem.outerWidth() * horizontalItem.length;
  if (moveAmount <= 0) {
    moveAmount = 0;
    minHeight = 0;
...
var introDurationMS = 0;
var exitDurationMS = 1200;
...
},{"./styles.css":"src/styles.css","gsap":"node_modules/gsap/index.js","split-type":"node_modules/split-type/dist/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "41055" + '/');
